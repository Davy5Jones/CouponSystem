...
public class Test {
    private static final LoginManager loginManager = LoginManager.getLoginManager();
    private static final Thread task = new Thread(Job.getJob());
    ...
    public static void testAll() throws SQLException {
        try {
            ...
            System.out.println(companyFacade1.companyDetails());
